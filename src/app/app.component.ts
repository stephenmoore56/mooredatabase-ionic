...
export class MyApp {
    ...
    constructor(public platform: Platform) {
        ...
        this.pages = [
            ...
            {title: 'Mobile Architecture', component: ArchitecturePage},
            {title: 'Species By Month', component: SpeciesByMonthPage},
            {title: 'Species By Location', component: SpeciesByLocationPage}
        ];
